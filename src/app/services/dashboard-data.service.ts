    ...
    return {
      ...
      navigation: {
        sideMenuItems: [
          ...
          { icon: '', label: 'Traffic Explorer', route: 'traffic-explorer' },
          { icon: '', label: 'Trend Analytics', route: 'trend-analytics' },
          { icon: '', label: 'Device Management', route: 'device-management' },
          { icon: '', label: 'System Health', route: 'system-health' },
